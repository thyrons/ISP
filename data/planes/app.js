...
angular.module('scotchApp').controller('planesController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/planes/xml_planes.php',
	        autoencode: false,
	        datatype: "xml",
			height: 200,
			colNames:['ID','NOMBRE'],
			colModel:[
				...
				{name:'nivel',index:'nivel',width:150, editable:true, editoptions:{size:"20", maxlength:"30"}, editrules: {required: true}},
